...
# Ideas: try higher dropout, maybe add a layer to LSTM, experiment with learning rate
...
class LSTM(nn.Module):
    def __init__(self, embedding_dim, hidden_dim, out_dim):
        ...
        # self.conversion_layer = nn.Linear(50, out_dim)
    ...
    def forward(self, x, score, train=True):
        ...
        # final_out = self.conversion_layer(lstm_sentence_average)
